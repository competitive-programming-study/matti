...
mod test_lcs {
    ...
    fn test_identical_strings() {
        assert_eq!(longest_common_subsequence_len("abcde", "abcde"), 5);
    }
    ...
    fn test_partial_match() {
        ...
        assert_eq!(longest_common_subsequence_len("abc", "ac"), 2);
        assert_eq!(longest_common_subsequence_len("AGGTAB", "GXTXAYB"), 4); // GTAB
    }

    #[test]
    fn test_repeated_characters() {
        assert_eq!(longest_common_subsequence_len("aaaa", "aa"), 2);
        assert_eq!(longest_common_subsequence_len("aabba", "ababa"), 4);
    }
    ...
    fn test_longer_strings() {
        let s1 = "abcdefghij";
        let s2 = "cdgi";
        assert_eq!(longest_common_subsequence_len(s1, s2), 4); // "cdgi"
    }
}
