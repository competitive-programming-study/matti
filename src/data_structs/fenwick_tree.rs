...
impl<T> FenwickTree<T> 
    where T:Add<Output = T> + Sub<Output = T> + Clone + Copy + Default {
...
impl <T> UpdateArray<T> where T: 
    Add<Output = T> + Sub<Output = T> + Neg<Output = T> + Clone + Copy + Default {
    pub fn with_len(n: usize, sum_invariant: T) -> Self {
        Self {
...
impl<T> RangeUpdate<T> 
    where T:    Neg<Output = T> + Sub<Output = T> + Add<Output = T> + Mul<usize,Output = T> +
                Clone + Copy + Default
    {
        pub fn with_len(n: usize, sum_invariant: T) -> Self {
            Self {
